...
class ShoppinglistsTest < ApplicationSystemTestCase
  ...
  test "creating a Shoppinglist" do
    visit shoppinglists_url
    click_on "New Shoppinglist"

    fill_in "Manipulator type", with: @shoppinglist.manipulator_type
    fill_in "Time", with: @shoppinglist.time
  ...
  test "updating a Shoppinglist" do
    visit shoppinglists_url
  ...
  test "destroying a Shoppinglist" do
    visit shoppinglists_url
